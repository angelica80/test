...
public class MainActivity extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_addContact) {
            ...
            contact.putExtra("name", "Angelica");
            startActivity(contact); //Startar aktiviteten
            return true;
        }
        else if (id == R.id.action_changeBackgroundColor) {
            Intent changeBackgroundActivity = new Intent(this, ColorActivity.class); //skapat ett nytt aktivitet som hämtar klassen ContactActivity
